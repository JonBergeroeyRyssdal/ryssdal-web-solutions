...
export const en: Dictionary = {
  ...
  heroTitle: "Websites for", heroAccent: "small businesses.",
  heroText: "I can help you build a new website, improve your existing one, or create a solution that saves you manual work.",
  contactAction: "Get in touch", servicesTitle: "How I can help.",
  websiteTitle: "Websites", websiteText: "A new, mobile-friendly website or an upgrade to your existing one. Make it easy for customers to find you and get in touch.",
  ...
  footer: "Websites and digital solutions for businesses.", title: "Websites for small businesses | Ryssdal Web Solutions",
};
